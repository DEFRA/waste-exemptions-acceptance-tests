...
class CheckDetailsPage < BasePage
  ...
  element(:change_exemptions, "a[href='check-your-answers/exemptions']")
  ...
  element(:change_applicant_name, "a[href='check-your-answers/applicant-name']")
  element(:applicant_tel, "#registration_telephone_number")
  element(:change_applicant_tel, "a[href='check-your-answers/applicant-phone']")
  element(:applicant_email, "#registration_email_address")
  element(:change_applicant_email, "a[href='check-your-answers/applicant-email']")
