...
class CheckDetailsPage < BasePage
  ...
  element(:change_charitable_purpose,
          "a[href='check-your-answers/charitable-purpose'],a[href='renewal-start/charitable-purpose']")
