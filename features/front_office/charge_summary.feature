...
Scenario: Single band one U1 exemption charges £450
    Given I am participating in the private beta
     ...
     Then I can see the registration charge is £41.00
      ...
      And I can see that the "Full" compliance charge of band 1 exemption is £409.00
...
Scenario: Multiple exemptions of the same band one have discounted exemptions
    Given I am participating in the private beta
     ...
     Then I can see the registration charge is £41.00
      ...
      And I can see that the "Full" compliance charge of band 1 exemption is £409.00
      And I can see that the "Discounted" compliance charge of band 1 exemption is £74.00
...
Scenario: Multiple exemptions of different bands 1, 2, 3 and 4
    Given I am participating in the private beta
     ...
     Then I can see the registration charge is £41.00
      ...
      And I can see that the "Full" compliance charge of band 4 exemption is £1180.00
      And I can see that the "Discounted" compliance charge of band 3 exemption is £30.00
