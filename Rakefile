...
task :ie11_W10 do
  sh %( QUKE_CONFIG=.config_ie11_W10.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Edge 16 Windows 10 test"
task :Edge16_W10  do
  sh %( QUKE_CONFIG=.config_Edge16_W10.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Edge 17 Windows 10 test"
task :Edge17_W10 do
  sh %( QUKE_CONFIG=.config_Edge17_W10.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Chrome 70 Windows 10 test"
task :Chrome70_W10 do
  sh %( QUKE_CONFIG=.config_Chrome70_W10.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Firefox 63 W10 test"
task :Firefox63_W10  do
  sh %( QUKE_CONFIG=.config_Firefox63_W10.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Safari 12 OS X Mojave test"
task :Safari12_OSX  do
  sh %( QUKE_CONFIG=.config_Safari12_OSX.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Chrome 70 OS X Mojave test"
task :Chrome70_OSX  do
  sh %( QUKE_CONFIG=.config_Chrome70_OSX.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Firefox 63 OS X Mojave test"
task :Firefox63_OSX  do
  sh %( QUKE_CONFIG=.config_Firefox63_OSX.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run iPhone XS test"
task :iPhone_XS do
  sh %( QUKE_CONFIG=.config_iPhone_XS.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run iPhone 8 plus test"
task :iPhone_8 do
  sh %( QUKE_CONFIG=.config_iPhone_8.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Samsung Galaxy Note 8 test"
task :Galaxy_Note_8 do
  sh %( QUKE_CONFIG=.config_Galaxy_Note_8.yml bundle exec quke --tags ~@wip --tags @smoke)
end

desc "Run Google Pixel 2 test"
task :Google_Pixel do
  sh %( QUKE_CONFIG=.config_Google_Pixel.yml bundle exec quke --tags ~@wip --tags @smoke)
end
